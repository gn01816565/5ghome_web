...
$editSql = "select * from Admin_MemberGroup where AMG_ID = '".$id."'";
...
function upSubmit(){
  ...
  if(!$('#gName').val()) {
    $('#gNameAlert').html('<i class="fa fa-warning"> 請輸入群組名稱！</i>');
    checkstatus=0;
  }
            ...
            <div class="tableWarp">
              <div id="formTable">
                <form id="formEdit" name="formEdit">
                  ...
                  <table>
                    <tr>
                      <td class="num titleTxt">群組名稱</td>
                      <td class="txtLeft" style="text-align:left;">
                        <input type="text" name="gName" id="gName" placeholder="請輸入群組名稱" value="<?=$editData['AMG_Name'];?>">
                        <span id="gNameAlert"></span>
                      </td>
                    </tr>
                    <tr>
                      <td class="num titleTxt">備註</td>
                      <td class="txtLeft" style="text-align:left;">
                        <textarea name="remark" id="remark" placeholder="請輸入備註" style='height:150px;'><?=$editData['AMG_Remark'];?></textarea>
                      </td>
                    </tr>
                  </table>
                </form>
