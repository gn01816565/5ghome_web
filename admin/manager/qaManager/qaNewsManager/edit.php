<?php
$upSql = "select * from Admin_QAAnnouncement where AQAA_ID = '1' ";
                ...
                <table id="pwUpdate">
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;" id="ckeditor">
                      <h3>
                        <textarea name="content" id="content" placeholder="請輸入問與答公告..." class="ckeditor"><?=$upData['AQAA_Content'];?></textarea>
                      </h3>
                  </tr>
                  <tr>
                    <td class="num titleTxt" style="width:200px;">
                    ...
                    <td class="txtLeft" style="text-align:left;">
                      <h3>
                        <?php
                        echo amAccountSearch($Language_db,$upData['AQAA_AM_ID']);
                        ?>
                    </h3>
                    </td>
                  </tr>
