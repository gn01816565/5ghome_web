...
$editSql = "select * from Admin_SupplierGroup where ASG_ID = '".$id."'";
                  ...
                  <table>
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <input type="text" name="title" id="title" placeholder="請輸入主類別名稱" value="<?=$editData['ASG_Name'];?>">  
                    ...
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <textarea name="remark" id="remark" placeholder="請輸入備註"><?=$editData['ASG_Remark'];?></textarea>
                      </td>
                    </tr>
                  </table>
                </form>
