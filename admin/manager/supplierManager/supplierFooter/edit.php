...
$id = $_GET['id']; //商品id
#供應商商品資料
$sqlfooter = "SELECT * FROM Supplier_IndexFooterManager WHERE SIFM_ID = '".$id."'";
$rsfooter = $Config_db->query($sqlfooter);
$datafooter = $rsfooter->fetch();
?>
<script>
function ajaxPro() {
                ...
                <table>
                  <tr>
                    ...
                    <td style="text-align:left;">
                       <img src='../images/supplier/<?=fiveSadAccountSearch($Config_db,$datafooter['SIFM_SAD_ID'])[1];?>/footer/<?=$datafooter['SIFM_Img'];?>' style="max-width:100%;">
                    </td>
                  </tr>
                  <tr>
                    <td class="num titleTxt">連結</td>
                    <td style="text-align:left;">
                      <a href='<?= $datafooter['SIFM_Url']; ?>' target="_blank" >
                        <?=$datafooter['SIFM_Url'];?>
                      </a>
                    </td>
                  </tr> 
                  <tr>
                    ...
                    <td style="text-align:left;"><?=sadAccountSearch($Config_db,$datafooter['SIFM_SAD_ID']);?></td>
                  </tr>
                  <tr>
                    <td class="num titleTxt">檔案資訊</td>
                    <td style="text-align:left;">
                      <?php
                      $imagesData = getimagesize("../images/supplier/".fiveSadAccountSearch($Config_db,$datafooter['SIFM_SAD_ID'])[1]."/footer/".$datafooter['SIFM_Img']."");
                  ...
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;">
                      <?php
                      #判斷管理者是否有下架
                        if($datafooter['SIFM_CheckStatus']=='N') {
                          echo "<text style='color:red'>管理者下架</text>";
                        } else {
                          #管理者沒下架，則判斷供應商是否有下架
                          if($datafooter['SIFM_CheckStatus']=='Y') {
                ...
                <form id="formEdit" name="formEdit">
                  ...
                  <table>
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <input type="radio" name="proStatus" value="Y" <? if($datafooter['SIFM_CheckStatus']=='Y') { echo "checked"; }?>>
                        <label>上架</label>
                        <input type="radio" name="proStatus" value="N" <? if($datafooter['SIFM_CheckStatus']=='N') { echo "checked"; }?>>
                        <label>下架</label>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <textarea name="remark" placeholder="請輸入原因..."><?=$datafooter['SIFM_Reason'];?></textarea>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <?php
                        if($datafooter['SIFM_AM_ID']) {
                          echo amAccountSearch($Language_db,$datafooter['SIFM_AM_ID']);
                        } else {
                          echo "無紀錄";
                        }
                        ?>
            ...
            <div id="formTable">
                <table>
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;">
                        <?=$datafooter['SIFM_SADClaimReason'];?>
                    </td>
                  </tr>
                  <tr>
                    <td class="num titleTxt" style="width:120px;">請求時間</td>
                    <td class="txtLeft" style="text-align:left;">
                        <?=$datafooter['SIFM_SADClaimTime'];?>
                    </td>
                  </tr>
                </table>
            </div>
