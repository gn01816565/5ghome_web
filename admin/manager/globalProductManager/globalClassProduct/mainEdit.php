...
$editSql = "select * from Admin_GlobalProductMainClass where AGPMC_ID = '".$id."'";
            ...
            <div class="tableWarp">
              <div id="formTable">
                <form id="formEdit" name="formEdit">
                  ...
                  <input type="hidden" name="agpmcID" id="agpmcID" value="<?=$id;?>">
                  <table>
                    <tr>
                      <td class="num titleTxt">標題</td>
                      <td class="txtLeft" style="text-align:left;">
                        <input type="text" name="title" id="title" placeholder="請輸入主類別標題" value="<?=$editData['AGPMC_Name'];?>">  
                    ...
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <textarea name="remark" id="remark" placeholder="請輸入備註"><?=$editData['AGPMC_Remark'];?></textarea>
                      </td>
                    </tr>
                  </table>
                </form>
