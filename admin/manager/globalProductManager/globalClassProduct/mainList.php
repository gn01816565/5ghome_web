...
function ajaxPro(mid) {
  ...
  var URLs  = "manager/<?=$mainDirectory;?>/<?=$subDirectory;?>/mainProcess.php";
  $.ajax({
    url: URLs,
    data: { id:mid,act:"del"},
    type:"POST",
      ...
      <section id="rightWarp">
        ...
        <div id="pageIndexWarp" class="boxWarp">
          <div id="toolsBar" class="boxWarp">
            <button class="blue" onclick="location.href='page_index.php?pageData=<?=$_GET['pageData'];?>&secondURL=mainAdd'">新增主類別</button>
          </div>
              ...
              <div class="tableWarp">
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                      <h3>
                        <a href='page_index.php?pageData=<?=$_GET['pageData'];?>&secondURL=subList&mid=<?=$dataContent['AGPMC_ID']?>'>
                    ...
                    <td>
                      <button class="yellow toolsBtn" onclick="location.href='page_index.php?pageData=<?=$_GET['pageData'];?>&secondURL=mainEdit&id=<?=$dataContent['AGPMC_ID'];?>'">修改</button>
                    </td>
                    <td>
