...
//$SQLbannerClick = "SELECT * FROM  Admin_IndexAdClick where AIAC_Unit like 'ad'  $SQLplus group by AIAC_IDNum ORDER BY AIAC_ID DESC ";
  $SQLbannerClick = "SELECT * FROM  Admin_IndexAdClick where AIAC_Unit like 'ad' group by AIAC_IDNum ORDER BY AIAC_ID DESC ";
...
//for($i = 0; $i <= count($dataAllPageClick); $i++ ) {
  ...
  foreach($databannerClick as $key => $val) {
    //$SQLamountBannerClick = "SELECT count(*) FROM Admin_IndexAdClick WHERE AIAC_Unit like 'ad' AND AIAC_IDNum = '".$val['AIAC_IDNum']."' $SQLplus";
    $SQLamountBannerClick = "SELECT count(*) FROM Admin_IndexAdClick WHERE AIAC_Unit like 'ad' AND AIAC_IDNum = '".$val['AIAC_IDNum']."'";
...
var options = {
  title: '側邊廣告點擊排行 / AD Click Ranking',
                  ...
                  <tr>
                    ...
                    <td>
                      <a href='' target="_blank">
                        <?php                        
                        if(file_exists('../images/adImage/'.$key)==true){
                          echo "<img src='../images/adImage/".$key."' style='max-width:100%;'>";
                        } else {
                          echo "圖片已移除";
                        } //if(is_file)
