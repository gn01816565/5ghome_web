      ...
      <section id="rightWarp">
        ...
        <div id="pageIndexWarp" class="boxWarp">
          <div id="toolsBar" class="boxWarp">
            <button class="blue" onclick="location.href='page_index.php?pageData=<?=$_GET['pageData'];?>&secondURL=add'">新增AD廣告</button>
          </div>
          <div id="newsWarp" class="boxWarp">
            ...
            <div class="tableWarp">
              <table>
                ...
                $all_num = allTableNum($Language_db,'Admin_IndexIconManager'); 
                $pageAll_num = ceil($all_num / $read_num); //頁碼數計算，全部數量/讀取數量 

                #列出紀錄資料
                $sqlList = "SELECT * FROM Admin_IndexIconManager ORDER BY  AIIM_Sort  ASC  limit $star_num, $read_num";
                ...
                <tr>
                  ...
                  <td>
                    <h3>
                      <a href='<?=$dataList['AIIM_Url'];?>' target='_blank'>
                        <img src="../images/adImage/<?=$dataList['AIIM_Img'];?>" width="200">
                      </a>
                    </h3>
                  </td>
                  <td>
                    <h3><?=$dataList['AIIM_UploadDate'];?></h3>
                  </td>
                  <td>
                    <button class="yellow toolsBtn" onclick="location.href='page_index.php?pageData=<?=$_GET['pageData'];?>&secondURL=edit&id=<?=$dataList['AIIM_ID'];?>'">修改</button>
                  </td>
                  <td>
                    <button class="red toolsBtn" onclick='delSubmit(<?=$dataList['AIIM_ID'];?>)'>刪除</button>
                  </td>
                </tr>
                <?php
