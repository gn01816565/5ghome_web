<?php
$upSql = "select * from Admin_IndexBusinessRule where AIBR_ID = '1' ";
                ...
                <table id="pwUpdate">
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;" id="ckeditor">
                      <h3>
                        <textarea name="content" id="content" placeholder="請輸入會員規範內文..." class="ckeditor" ><?=$upData['AIBR_Content'];?></textarea>
                        <!--
                  ...
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;">
                      <h3>
                        <?php
                        echo amAccountSearch($Language_db,$upData['AIBR_AM_ID']);
                        ?>
                    </h3>
                    </td>  
                  </tr>
