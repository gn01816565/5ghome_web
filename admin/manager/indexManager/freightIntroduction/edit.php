<?php
$upSql = "select * from Admin_IndexFreightIntroduction where AIFI_ID = '1' ";
                ...
                <table id="pwUpdate">
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;" id="ckeditor">
                      <h3>
                        <textarea name="content" id="content" placeholder="請輸入購物說明內文..." class="ckeditor" ><?=$upData['AIFI_Content'];?></textarea>
                        <!--
                  ...
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;">
                      <h3>
                        <?php
                        echo amAccountSearch($Language_db,$upData['AIFI_AM_ID']);
                        ?>
                    </h3>
                    </td>
                  </tr>
