<?php
$upSql = "select * from Admin_IndexAboutManager where AIAM_ID = '1' ";
                ...
                <table id="pwUpdate">
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;" id="ckeditor">
                      <h3>
                        <textarea name="content" id="content" placeholder="請輸入關於FIVESTARS內文..." class="ckeditor" ><?=$upData['AIAM_Content'];?></textarea>
                        <!--
                  ...
                  <tr>
                    ...
                    <td class="txtLeft" style="text-align:left;">
                      <h3>
                        <?php
                        echo amAccountSearch($Language_db,$upData['AIAM_AM_ID']);
                        ?>
                    </h3>
                    </td>  
                  </tr>
