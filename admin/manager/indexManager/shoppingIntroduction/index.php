...
$secondURL = isset($_GET['secondURL'])?$_GET['secondURL']:""; //用在第二個轉頁判斷，如主功能底下的新增、刪除、修改頁面 , 抓取目錄代
//$mainDirectory = "indexManager"; //資料夾第一層目錄
//$subDirectory = "shoppingIntroduction"; //資料夾第二層目錄
