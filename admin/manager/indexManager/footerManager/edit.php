<?php
$id = $_GET['id']; //使用者id
$editSql = "select * from Admin_IndexFooterManager where AIFM_ID = '".$id."'";
            ...
            <div class="tableWarp">
              <div id="formTable">
                <form id="formFileAdd" name="formFileAdd" action="manager/<?=$mainDirectory;?>/<?=$subDirectory;?>/process.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="fileName" id="fileName" value="<?=$editData['AIFM_Img'];?>">
                  <input type="hidden" name="bid" id="bid" value="<?=$id;?>">
                  <table>
                    <tr>
                      <td class="num titleTxt">上傳檔案</td>
                      <td class="txtLeft" style="text-align:left;">
                        <button class="yellow" type="button" onclick="imgOpen('../images/footerImage/<?=$editData['AIFM_Img'];?>')" target='_blank'><?=$editData['AIFM_Img'];?></button>
                        <br><br>
                        重新上傳圖片：
                    ...
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <input type="text" name="imgUrl" id="imgUrl" placeholder="請輸入您的廣告所連結路徑，如：www.fivestars.com/tw/fivestars/" value="<?=$editData['AIFM_Url'];?>">
                      </td>
                    </tr>
                    <tr>
                      <td class="num titleTxt">建立日期</td>
                      <td class="txtLeft" style="text-align:left;">
                        <?=$editData['AIFM_UploadDate'];?>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <?php
                        echo amAccountSearch($Language_db,$editData['AIFM_AM_ID']);
                        ?>
                      </td>
                    </tr>
                  </table>
        ...
        <div class="pageBtnWarp">
          <ul>
            ...
            <li>
              ...
              <button class="red" type="submit">更新</button>
            </li>
          </ul>
        </div>  
      </form>
