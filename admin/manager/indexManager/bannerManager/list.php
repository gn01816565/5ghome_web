      ...
      <section id="rightWarp">
        ...
        <div id="pageIndexWarp" class="boxWarp">
          <div id="toolsBar" class="boxWarp">
            <button class="blue" onclick="location.href='page_index.php?pageData=<?=$_GET['pageData'];?>&secondURL=add'">新增Banner</button>
          </div>
          <div id="newsWarp" class="boxWarp">
            ...
            <div class="tableWarp">
              <table>
                ...
                $all_num = allTableNum($Language_db,'Admin_IndexBannerManager'); 
                $pageAll_num = ceil($all_num / $read_num); //頁碼數計算，全部數量/讀取數量 

                #列出紀錄資料
                $sqlList = "SELECT * FROM Admin_IndexBannerManager ORDER BY  AIBM_Sort  ASC  limit $star_num, $read_num";
                ...
                <tr>
                  ...
                  <td>
                    <h3>
                      <a href='<?=$dataList['AIBM_Url'];?>' target="_blank" >
                        <img src="../images/bannerImage/<?=$dataList['AIBM_Img'];?>" width="80%">
                      </a>
                    </h3>
                  </td>
                  <td>
                    <h3><?=$dataList['AIBM_UploadDate'];?></h3>
                  </td>
                  <td>
                    <button class="yellow toolsBtn" onclick="location.href='page_index.php?pageData=<?=$_GET['pageData'];?>&secondURL=edit&id=<?=$dataList['AIBM_ID'];?>'">修改</button>
                  </td>
                  <td>
                    <button class="red toolsBtn" onclick='delSubmit(<?=$dataList['AIBM_ID'];?>)'>刪除</button>
                  </td>
                </tr>
                <?php
