<?php
$id = $_GET['id']; //使用者id
$editSql = "select * from Admin_IndexBannerManager where AIBM_ID = '".$id."'";
      ...
      <section id="rightWarp">
        ...
        <div id="pageIndexWarp" class="boxWarp">
         <div id="toolsBar" class="boxWarp" style="background-color: #BDE5F8;color: #00529B;">
            <i class="fa fa-info-circle"></i>建議上傳banner的圖，寬度1000px以上，高度不限
          </div>
            ...
            <div class="tableWarp">
              <div id="formTable">
                <form id="formFileAdd" name="formFileAdd" action="manager/<?=$mainDirectory;?>/<?=$subDirectory;?>/process.php" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="fileName" id="fileName" value="<?=$editData['AIBM_Img'];?>">
                  <input type="hidden" name="bid" id="bid" value="<?=$id;?>">
                  <table>
                    <tr>
                      <td class="num titleTxt">上傳檔案</td>
                      <td class="txtLeft" style="text-align:left;">
                        <button class="yellow" type="button" onclick="imgOpen('../images/bannerImage/<?=$editData['AIBM_Img'];?>')" target='_blank'><?=$editData['AIBM_Img'];?></button>
                        <br><br>
                        重新上傳圖片：
                    ...
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <input type="text" name="imgUrl" id="imgUrl" placeholder="請輸入您的廣告所連結路徑，如：www.fivestars.com/tw/fivestars/" value="<?=$editData['AIBM_Url'];?>">
                      </td>
                    </tr>
                    <tr>
                      <td class="num titleTxt">建立日期</td>
                      <td class="txtLeft" style="text-align:left;">
                        <?=$editData['AIBM_UploadDate'];?>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <?php
                        echo amAccountSearch($Language_db,$editData['AIBM_AM_ID']);
                        ?>
                      </td>
                    </tr>
                  </table>
