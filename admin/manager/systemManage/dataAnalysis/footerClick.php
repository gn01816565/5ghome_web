...
$SQLbannerClick = "SELECT * FROM  Admin_IndexAdClick where AIAC_Unit like 'footer'  $SQLplus group by AIAC_IDNum ORDER BY AIAC_ID DESC ";
...
foreach($databannerClick as $key => $val) {
  $SQLamountBannerClick = "SELECT count(*) FROM Admin_IndexAdClick WHERE AIAC_Unit like 'footer' AND AIAC_IDNum = '".$val['AIAC_IDNum']."' $SQLplus";
...
var options = {
  title: 'Footer點擊排行 / Footer Click Ranking',
                  ...
                  <tr>
                    ...
                    <td>
                      <a href='' target="_blank">
                        <?php                        
                        if(file_exists('../images/footerImage/'.$key)==true){
                          echo "<img src='../images/footerImage/".$key."' width='100%'>";
                        } else {
                          echo "圖片已移除";
                        } //if(is_file)
