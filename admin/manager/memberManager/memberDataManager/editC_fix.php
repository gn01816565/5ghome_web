...
error_reporting(E_ALL & ~E_NOTICE);
  ...
  $sqlMemAccount = "SELECT * 
                    ...
                    WHERE MAD_Num = '".$id."'";
  $rsMemAccount = $Language_db->query($sqlMemAccount);
  $dataMemAccount = $rsMemAccount->fetch();
  /*
  #依會員類型，列出不同資料表
  $mTable="";
  if($dataMemAccount['MAD_Type']=='company') {//公司會員
      ...
      ?>
        <section id="rightWarp">
          ...
          <div id="pageIndexWarp" class="boxWarp">
                ...
                <div id="formTable">
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;">
                        <input type="text" name="lastName" value="<?=$dataProDetail['MADG_LastName'];?>" >
                      </td>
                    </tr>
                    <tr>
                      <td class="num titleTxt">名</td>
                      <td class="txtLeft" style="text-align:left;">
                        <input type="text" name="name" value="<?=$dataProDetail['MADG_Name'];?>" >
                      </td>
                    </tr>
                    <tr>
                      <td class="num titleTxt">生日</td>
                      <td class="txtLeft" style="text-align:left;">
                        <input type="text" name="birthday" id="birthday" placeholder="生日" style="width:100px;">
                    ...
                    <tr>
                      ...
                      <td class="txtLeft" style="text-align:left;"></td>
                    </tr>
                    <tr>
                  ...
                  <form id="formEdit" name="formEdit">
                    ...
                    <table>
                      <tr>
                        ...
                        <td class="txtLeft" style="text-align:left;">
                          <input type="radio" name="proStatus" value="Y" <?php if($dataProDetail['SPD_CheckStatus']=='Y') { echo "checked"; }?>>
                          <label>上架</label>
                          <input type="radio" name="proStatus" value="N" <?php if($dataProDetail['SPD_CheckStatus']=='N') { echo "checked"; }?>>
                          <label>下架</label>
                        </td>
                      </tr>
                      <tr>
            ...
            <?php
              } //end if($dataProDetail['SPD_SADClaim']=='Y')
            ?>
