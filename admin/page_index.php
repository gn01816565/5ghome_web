...
<html>
  ...
  <body>  
    ...
    <div id="topLineWarp" class="red">
      <div class="btnWarp">
        <ul>
          <li><a href="../tc" class="red" title="連結官網" target="_blank">連結官網</a></li>
          <li><a href="../tc_admin/login.php" class="yellow" title="連結供應商首頁" target="_blank">連結供應商首頁</a></li>
    ...
    $rsToPage = $_db->query("select * from Admin_ManagerCompetence ORDER BY AMC_ID ASC ");  
...
<script src="../jquery/jquery-migrate-1.3.0.min.js"></script>
...
/*
  var $multiselectJQuery = jQuery.noConflict(); 
  $multiselectJQuery(function() {
    $multiselectJQuery.localise('ui-multiselect', {language: 'de', path: 'js/locale/'});
    $multiselectJQuery(".multiselect").multiselect();
